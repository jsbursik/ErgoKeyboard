module.exports = {
  ...
  ${"" /* footprint reference */}
  (fp_text reference "${p.ref}" (at 0 1.625) (layer "F.SilkS") ${p.ref_hide} (effects (font (size 1.2 1.2) (thickness 0.2032))))
  ...
  `;
    function pins(def_neg, def_pos) {
      ...
      (pad "1" thru_hole circle (at -13.97 ${def_pos}7.62) (size 1.7526 1.7526) (drill 1.0922) (layers *.Cu *.SilkS *.Mask) 
      ...
      ${"" /* battery pins NOT VERIFIED DIMENSIONS*/}
      (pad "25" thru_hole rect (at -16.51 ${def_neg}7.62 ${p.rot}) (size 1.2519 1.2519) (drill 1.0922) (layers *.Cu *.SilkS *.Mask)
      (pad "26" thru_hole circle (at -16.51 ${def_pos}-7.62) (size 1.2519 1.2519) (drill 1.0922) (layers *.Cu *.SilkS *.Mask) 
